<template>
  <Modal :title="data.id ? '修改菜单' : '新增菜单'" class-name="edit-modal" :value="show" :width="1000" @on-ok="ok" @on-cancel="close">
    <div class="edit-modal-body">
      <div class="inline-box box">
        <Tree :data="menuTree" />
      </div>
    </div>
  ...
  <!-- <EditModal :title="data.id ? '修改菜单' : '新增菜单'" :forms="forms" :edit-data="data" @close="close" @ok="ok" :show="show">
